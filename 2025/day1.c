...
static int
readFile(const char *fileName, char **lines)
{
...
static int
turnDial(char ** instructions, int numberOfInstructions, bool part2)
{
	...
	for (int i = 0; i < numberOfInstructions; i++)
	{
		...
		if( previousPosition != 0 &&(currentPosition> 99 || currentPosition<1))
		{
			numberOfPasses++;
		}
